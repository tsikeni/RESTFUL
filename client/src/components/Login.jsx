...
function Login() {
  ...
  return (
    <div>
      ...
      {showSuccessMessage && (
        <div className="fixed top-0 right-0 p-4 m-4 bg-green-500 text-white rounded-lg shadow-lg">
          ...
          <div className="md:flex w-full">
            ...
            <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
              <div className="text-center mb-10">
                <h1 className="font-bold text-3xl text-gray-900">Login Form</h1>
                  <p>Enter your information for logging In</p>
                </div>
